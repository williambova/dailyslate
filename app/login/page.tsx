...
function LoginInner() {
  ...
  // Where to land after auth (e.g. /join/SLATE-XXXX from an invite link).
  const rawNext = searchParams.get("next") ?? "/slate";
  const next = rawNext.startsWith("/") ? rawNext : "/slate";
  ...
  return (
    <div className="app-bg flex min-h-screen flex-col px-6 pb-10 pt-8">
      <div className="mx-auto w-full max-w-[420px]">
        <Link
          href={next.startsWith("/join") ? next : "/profile"}
