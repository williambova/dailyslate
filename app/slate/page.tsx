...
import { Radio, RefreshCw, CalendarX, Activity } from "lucide-react";
...
export default function SlatePage() {
  ...
  // Pickable games grouped by sport; started games (live/final) shown apart
  // so the board you can still act on is never mixed with games in progress.
    ...
    <div className="px-4 pb-2 pt-4">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          {sections.length === 0 && startedGames.length > 0 && (
